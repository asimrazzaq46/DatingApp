...
namespace API.Data.Migrations
{
    ...
    [Migration("20241110104210_photoApprovedAdded")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Entities.UserLike", b =>
                {
                    b.Property<int>("SourcerUserId")
                        .HasColumnType("INTEGER");

                    b.Property<int>("TargetUserId")
                        .HasColumnType("INTEGER");

                    b.HasKey("SourcerUserId", "TargetUserId");
            ...
            modelBuilder.Entity("API.Entities.UserLike", b =>
                {
                    b.HasOne("API.Entities.AppUser", "SourcerUser")
                        .WithMany("LikedUsers")
                        .HasForeignKey("SourcerUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
